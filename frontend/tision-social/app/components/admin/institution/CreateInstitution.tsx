...
import { addInstitution } from "@/app/data/store/slices/institution/institutionSlice";
...
const CreateInstitution: React.FC<CloseProps> = ({ close }) => {
    ...
    const onSubmit: SubmitHandler<InstitutionInterface> = (data) => {
        ...
        dispatch(addInstitution(institution));
        setOfferInput("");
        setOffers([]);
        close();
    }
